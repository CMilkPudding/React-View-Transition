...
import type { ViewTransitionStartGroupRef } from '@/End/Group'
                            ...
                            <div className="flex-1 overflow-auto px-4 pb-4">
                                ...
                                >
                                    <div className="space-y-3">
                                        {products.map((product) => (
                                            <div key={product.id} className="flex gap-3 rounded-lg">
                                                <div className="rounded flex-shrink-0">
                                                    <ViewTransitionEnd id={`product-${product.id}`}>
                                                        <img className="w-24 h-32 object-cover" src={product.image} alt={product.name} />
                                                    </ViewTransitionEnd>
                                                </div>
                                                <div className="flex-1 flex flex-col justify-between">
                                                    <div>
                                                        ...
                                                        <p className={'text-xs text-gray-500 mb-2 transition-all duration-200 ease-out delay-100 ' +
                                                            ...
                                                            Premium quality product from our collection  Premium quality product from our collection Premium quality product from our collection Premium quality product from our collection
                                                        </p>
                                                    </div>
