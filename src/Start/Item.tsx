...
export interface ViewTransitionStartItemProps {
  /** 子元素，仅支持单个根元素 */
...
export default function ViewTransitionStartItem({
  children,
  id,
  mode: propMode,
  onClick: propOnClick,
}: ViewTransitionStartItemProps) {
  ...
  const capturePosition = useCallback(() => {
    if (elRef.current) {
      validateId(id)
      console.log('capturePosition called for:', id, elRef.current)
